...
datastory_name <- "erc_grantees_with_snsf_grants"
...
# characters etc.)
datastory_name_de <- "erc-grantees-snf-grants"
datastory_name_en <- "erc-grantees-snsf-grants"
datastory_name_fr <- "boursiers-cer-grants-fns"

# English title and lead of the story (Mandatory, even if no EN version)
title_en <- "The SNSF funds over 80% of researchers from Switzerland before their first ERC grant"
lead_en <- "Researchers working in Switzerland are very successful with applications to the European Research Council (ERC). Our analysis shows: By 2019, 84% of these grantees had previously received funding from the SNSF."

# German title and lead of the story (Mandatory, even if no DE version)
title_de <- "Der SNF fördert über 80% der Forschenden aus der Schweiz vor ihrem ersten ERC-Beitrag"
lead_de <- "In der Schweiz tätige Forschende sind sehr erfolgreich mit Bewerbungen beim Europäischen Forschungsrat (ERC). Unsere Analyse zeigt: Bis 2019 haben 84% dieser Beitragsempfangenden zuvor Finanzierung durch den SNF erhalten." 

# French title and lead of the story (Mandatory, even if no FR version)
title_fr <- "Le FNS finance plus de 80 % des chercheuses et chercheurs de la Suisse avant leur première bourse CER"
lead_fr <- "Les chercheuses et chercheurs qui travaillent en Suisse ont beaucoup de succès avec les subsides du Conseil européen de la recherche (CER, ERC). Notre analyse montre que jusqu’en 2019, 84 % de ces bénéficiaires avaient déjà reçu des fonds du FNS." 

# Contact persons, always (first name + last name)
contact_person <- c("Georges Klein", "Julius Mattern")
...
publication_date <- "2021-05-04 04:00:00"
...
github_url <- "https://github.com/snsf-data/datastory_erc_grantees_with_snsf_grants"
# Put Tag IDs here. Only choose already existing tags. 
tags_ids <- c(130, 140, 150, 120)
